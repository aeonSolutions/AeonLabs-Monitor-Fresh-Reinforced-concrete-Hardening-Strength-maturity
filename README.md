...
[May 7, 2023] - The firmware 1.0.13 for Over the Air Updates is now released to the public. Goto the [releases](https://github.com/aeonSolutions/AeonLabs-Monitor-Fresh-Reinforced-concrete-Hardening-Strength-maturity/releases) section to learn more.  
